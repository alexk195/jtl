...
public class example1 extends JTLTemplate
{
  ...
  JTLEntity entity=null; if ( object instanceof JTLEntity) entity=(JTLEntity)object;
  JTLEntity root=entity;
  // Code from jtl file follows
println("Tutorial 1: Hello JTL World!!!");                                      _line(1);
for (JTLEntity e:root.children) {
